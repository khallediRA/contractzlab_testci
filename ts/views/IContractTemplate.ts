...
export const keysofIContractTemplate: (keyof IContractTemplate)[] = ["id", "language", "code", "name", "level1Id", "level2Id", "createdAt", "updatedAt", "level3Id", "display", "clauses", "clausesId", "level3", "level2", "level1", "Contract_as_template", "Contract_as_templateId"]
