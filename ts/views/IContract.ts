...
export const keysofIContract: (keyof IContract)[] = ["id", "status", "name", "paramValues", "excludedClauses", "excludedSubClauses", "annexes", "fileNames", "level1Id", "level2Id", "level3Id", "clientId", "level", "createdAt", "updatedAt", "templateId", "display", "level1", "level2", "level3", "template", "client", "ContractUnion_as_contract", "ContractUnion_as_contractId"]
